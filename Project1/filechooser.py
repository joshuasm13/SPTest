...
-Around line 623
-dirselect set to true instead of false
...
class FileChooserController(RelativeLayout):
    ...
    current_directory = ListProperty([])
    ...
    dirselect = BooleanProperty(True)   # This originally set to False  -------------------------------------------------------
    '''
...
#===============================================================================================================
        ...
        if not self.multiselect:
            if self.file_system.is_dir(entry.path) and not self.dirselect:
                ...
                if self.dirselect and self.file_system.is_dir(entry.path):
                    ...
                    if statement. self.open_entry was already there
    ...
    def _get_file_paths(self, items):
        ...
        for i in range (8):
            print "\n"
        print [file.path for file in items]
